...
export const SearchRepositoriesDocument = new TypedDocumentString(`
  ...
  search(type: REPOSITORY, query: "user:bcgov language:TypeScript", first: 100) {
    ...
    `) as unknown as TypedDocumentString<SearchRepositoriesQuery, SearchRepositoriesQueryVariables>;